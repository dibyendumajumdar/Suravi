...
[Torch](https://github.com/dibyendumajumdar/ravi-torch7) code. Inspired by the
...
* provide automatic differentiation of [Torch](https://github.com/dibyendumajumdar/ravi-torch7)
  expressions
* support arbitrary Torch types (e.g. transparent and full support
  for CUDA-backed computations)
* full integration with [nn](https://github.com/dibyendumajumdar/ravi-torch7-nn) modules: mix and match
...
The [nn](https://github.com/dibyendumajumdar/ravi-torch7-nn) library provides with all sorts of very optimized
...
<img src="image/DebuggerExample.png">
...
[See LICENSE file](https://github.com/dibyendumajumdar/ravi-torch7-autograd/blob/ravi-distro/LICENSE).

...
[adagrad](t7optalgos.md#optim.adagrad) and
[adam](t7optalgos.md#optim.adam).
...
algorithm. This class is [serializable](t7serialization.md#serialization).

<a name="nn.StochasticGradient"></a>
### StochasticGradient(module, criterion) ###

Create a `StochasticGradient` class, using the given [Module](t7nnmodule.md#nn.Module) and [Criterion](t7nncriterion.md#nn.Criterion).
...
like [table layers](t7nntable.md#nn.TableLayers)). The label type depends of the criterion.
For example, the [MSECriterion](t7nncriterion.md#nn.MSECriterion) expects a Tensor, but the
[ClassNLLCriterion](t7nncriterion.md#nn.ClassNLLCriterion) except a integer number (the class).

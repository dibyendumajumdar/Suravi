...
target, they compute a gradient according to a given loss function.
  ...
  * Classification criterions:
    * [`BCECriterion`](#nn.BCECriterion): binary cross-entropy for [`Sigmoid`](t7nntransfer.md#nn.Sigmoid) (two-class version of [`ClassNLLCriterion`](#nn.ClassNLLCriterion));
    * [`ClassNLLCriterion`](#nn.ClassNLLCriterion): negative log-likelihood for [`LogSoftMax`](t7nntransfer.md#nn.LogSoftMax) (multi-class);
    * [`CrossEntropyCriterion`](#nn.CrossEntropyCriterion): combines [`LogSoftMax`](t7nntransfer.md#nn.LogSoftMax) and [`ClassNLLCriterion`](#nn.ClassNLLCriterion);
...
This class is [serializable](t7file.md#serialization-methods).
...
In general `input` and `target` are [`Tensor`s](t7tensor.md), but some specific criterions might require some other type of object.
...
Obtaining log-probabilities in a neural network is easily achieved by adding a [`LogSoftMax`](t7nntransfer.md#nn.LogSoftMax) layer in the last layer of your neural network.
